...
export interface components {
    schemas: {
        ...
        EventPredicate: {
            ...
            | components["schemas"]["SplQueryPredicate"]
        ...
        /** @description Map from tag key to an ordered set of attribute paths to search for values. All paths will be tried, and all found values will be added. If no value is found, the tag will not be changed. The attribute paths are are a list of paths. This does not remove existing tag values. */
        ImmutableSetListString: string[][];
        /** @description Map from tag key to an ordered set of attribute paths to search for values. All paths will be tried, and all found values will be added. If no value is found, the tag will not be changed. The attribute paths are dot-separated. This does not remove existing tag values. */
        ImmutableSetString: string[];
        ...
        MetricAggSpec: {
             ...
             * @enum {string}
             */
            timeAggregation?: MetricAggSpecTimeAggregation;
            /**
             ...
             * @enum {string}
             */
            spaceAggregation?: MetricAggSpecTimeAggregation;
        };
        ...
        SplQueryPredicate: {
            /**
             * @description The spl query used by the predicate. See https://docs.splunk.com/Documentation/SplunkCloud/9.3.2408/SearchReference
             * @example search service=grepr-service-1
             */
            query: string;
            /**
             * @description A predicate that checks if an event matches an SPL query. (enum property replaced by openapi-typescript)
             * @enum {string}
             */
            type: SplQueryPredicateType;
        };
        ...
        TemplateOperation: {
            ...
            /**
             * Format: int32
             * @description The version of the template to use for this operation. If not specified, the latest version will be used on the next pipeline restart. Note that whether templates are forward- or backward-compatible are dependent on the template script, so updating or downgrading versions may result in an error in the job depending on the script.
             * @example 4
             */
        ...
        NewRelic: {
            ...
            /** @description Whether to use Babel Fish for query processing */
        ...
        /** @description Team assignment for an invitation */
        TeamAssignment: {
            /**
...
export type SchemaIgnoreAttributesMergeStrategy =
    components["schemas"]["IgnoreAttributesMergeStrategy"];
export type SchemaImmutableSetListString =
    components["schemas"]["ImmutableSetListString"];
export type SchemaImmutableSetString =
    components["schemas"]["ImmutableSetString"];
...
export type SchemaSpansSynchronousSink =
    components["schemas"]["SpansSynchronousSink"];
export type SchemaSplQueryPredicate =
    components["schemas"]["SplQueryPredicate"];
...
export enum GreprRawLogsSourceSortOrder {
    ASCENDING = "ASCENDING",
...
export enum MetricAggSpecTimeAggregation {
    LATEST = "LATEST",
    SUM = "SUM",
    AVG = "AVG",
    MAX = "MAX",
...
export enum SplQueryPredicateType {
    spl_query = "spl-query",
}
