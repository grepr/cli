...
<HiddenFAQ faqs={[
  {
    ...
    a: "Go to Log Explorer, select a dataset and time range, enter a search query, then open the Analyze... drawer under the search controls. Enter Grepr SQL expressions for the values to compute, the expressions to group by, and the sort order."
  },
  {
